...
def create_html_report(all_results, html_manager):
    ...
    <div class="model-report">
        <h2>KORD Temperature Prediction Using Selected Airport Features (Random Forest)</h2>
    ...
    html_content = html_manager.template.format(
        title=f"KORD Temperature Prediction Using {', '.join(REGRESSOR_AIRPORTS)} Features (Random Forest)",
        content=content,
        additional_js=""
    )
    html_filename = "3-random_forest_temp_shift.html"
...
def main():
    try:
        ...
        feature_importance_map_1h = plot_feature_importance_map(metrics_1h['Feature_Importance'], output_dir / '3-feature_importance_map_1h.png', top_n=10)
        ...
        feature_importance_map_24h = plot_feature_importance_map(metrics_24h['Feature_Importance'], output_dir / '3-feature_importance_map_24h.png', top_n=10)
        ...
        feature_importance_map_120h = plot_feature_importance_map(metrics_120h['Feature_Importance'], output_dir / '3-feature_importance_map_120h.png', top_n=10)
        ...
        feature_importance_map_5d_avg = plot_feature_importance_map(metrics_5d_avg['Feature_Importance'], output_dir / '3-feature_importance_map_5d_avg.png', top_n=10)
        ...
        feature_importance_map_30d_avg = plot_feature_importance_map(metrics_30d_avg['Feature_Importance'], output_dir / '3-feature_importance_map_30d_avg.png', top_n=10)
