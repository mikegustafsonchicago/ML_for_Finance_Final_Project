...
def plot_feature_importance(feature_importance, output_dir):
    ...
    # Section-specific plot name
    plot_path = output_dir / '3-random_forest_wind_feature_importance.png'
    plt.savefig(plot_path, dpi=100, bbox_inches='tight')
    plt.close()
...
\\label{{tab:random_forest_wind_metrics_{suffix}}}
\\end{{table}}
...
\\label{{fig:random_forest_wind_results_{suffix}}}
\\end{{figure}}
...
\\label{{fig:random_forest_wind_importance_{suffix}}}
\\end{{figure}}
"""
    
    output_path = output_dir / f'3-random_forest_wind_results_{suffix}.tex'
...
def save_prediction_results(datetime_test, y_test, y_pred, output_dir):
    ...
    output_path = output_dir / '3-random_forest_wind_prediction_results.csv'
