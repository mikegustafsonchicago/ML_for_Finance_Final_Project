...
\\label{{tab:gradient_boost_temp_metrics_{suffix}}}
\\end{{table}}

\\begin{{figure}}[h]
\\centering
\\includegraphics[width=0.8\\textwidth]{{6-{suffix}-gradient_boosted_temp_regression_results.png}}
\\caption{{Gradient Boosted Temperature Prediction Results}}
\\label{{fig:gradient_boost_temp_results_{suffix}}}
\\end{{figure}}

\\begin{{figure}}[h]
\\centering
\\includegraphics[width=0.8\\textwidth]{{6-{suffix}-gradient_boosted_temp_feature_importance.png}}
\\caption{{Gradient Boosted Temperature Prediction Feature Importance}}
\\label{{fig:gradient_boost_temp_importance_{suffix}}}
\\end{{figure}}
"""
    
    output_path = output_dir / f'6-{suffix}-gradient_boosted_temp_results.tex'
